...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import Katherine.events

        path = Path(f"Katherine/modules/{shortname}.py")
        name = "Katherine.modules.{}".format(shortname)
        ...
        mod.Katherine = Katherine
        mod.tbot = telethn
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["Katherine.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "Katherine/modules/*.py"
