...
from Katherine.__main__ import STATS, TOKEN, USER_INFO
import Katherine.modules.sql.userinfo_sql as sql
from Katherine.modules.disable import DisableAbleCommandHandler
from Katherine.modules.sql.global_bans_sql import is_user_gbanned
from Katherine.modules.sql.afk_sql import is_afk, check_afk_status
from Katherine.modules.sql.users_sql import get_user_num_chats
from Katherine.modules.helper_funcs.chat_status import sudo_plus
from Katherine.modules.helper_funcs.extraction import extract_user
from Katherine import telethn as FallenTelethonClient, TIGERS, DRAGONS, DEMONS
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' [<a href="https://t.me/DevilsHeavenMF/16559">?</a>]'.format(
            bot.username
        )
