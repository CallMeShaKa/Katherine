from Katherine import telethn as tbot
...
from Katherine import OWNER_ID
from Katherine import TEMP_DOWNLOAD_DIRECTORY as path
from Katherine import TEMP_DOWNLOAD_DIRECTORY
from datetime import datetime
water = './Katherine/resources/fallen.jpg'
client = tbot
...
async def Prof(event):
    ...
    the_plugin_file = "./Katherine/modules/{}.py".format(input_str)
...
from Katherine.events import load_module
import asyncio
import os
from datetime import datetime
        ...
        try:
            downloaded_file_name = (
                await event.client.download_media(  # pylint:disable=E0602
                    ...
                    "Katherine/modules/",  # pylint:disable=E0602
                )
            )
...
from pathlib import Path
from Katherine import telethn as borg
