...
import Katherine.modules.sql.notes_sql as sql
from Katherine import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from Katherine.__main__ import DATA_IMPORT
from Katherine.modules.helper_funcs.chat_status import user_admin
from Katherine.modules.helper_funcs.alternate import typing_action

# from Katherine.modules.rules import get_rules
import Katherine.modules.sql.rules_sql as rulessql

# from Katherine.modules.sql import warns_sql as warnssql
import Katherine.modules.sql.blacklist_sql as blacklistsql
from Katherine.modules.sql import disable_sql as disabledsql

# from Katherine.modules.sql import cust_filters_sql as filtersql
# import Katherine.modules.sql.welcome_sql as welcsql
import Katherine.modules.sql.locks_sql as locksql
from Katherine.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("Katherine{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Katherine{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Katherine-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("Katherine{}.backup".format(chat_id))  # Cleaning file
