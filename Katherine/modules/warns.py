...
import telegram
from Katherine import TIGERS, WOLVES, dispatcher
from Katherine.modules.disable import DisableAbleCommandHandler
from Katherine.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
...
from Katherine.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from Katherine.modules.helper_funcs.string_handling import split_quotes
from Katherine.modules.log_channel import loggable
from Katherine.modules.sql import warns_sql as sql
